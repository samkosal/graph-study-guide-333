...
public class Practice {
  ...
  private static int oddVertices(Vertex<Integer> node, Set<Integer> visited) {
    int count = 0;
    if (node == null) {
      return 0;
    }
  ...
  public static List<Integer> sortedReachable(Vertex<Integer> starting) {
    ...
    List<Integer> sorted = sortedReachable(starting, visited);
    Collections.sort(sorted);
    // sorted.sort(null);
    return sorted;
  }
  private static List<Integer> sortedReachable(Vertex<Integer> node, Set<Vertex<Integer>> visited) {
    ...
    for (Vertex<Integer> neighbor : node.neighbors) {
      result.addAll(sortedReachable(neighbor, visited));
    }
  ...
  public static List<Integer> sortedReachable(Map<Integer, Set<Integer>> graph, int starting) {
    ...
    List<Integer> sorted = sortedReachable(graph, starting, visited);
    Collections.sort(sorted);
    // sorted.sort(null);
    return sorted;
  ...
  public static List<Integer> sortedReachable(Map<Integer, Set<Integer>> graph, int current, List<Integer> visited) { 
    List<Integer> result = new ArrayList<>();
    ...
    for (int neighbor : graph.get(current)) {
      result.addAll(sortedReachable(graph, neighbor, visited));
    }
